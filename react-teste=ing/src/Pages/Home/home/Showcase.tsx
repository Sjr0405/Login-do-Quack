...
const Section = styled.section`
  ...
  width: 100%;
  padding: 50px 20px;
  background-color: #1D1A37; // Cor de fundo roxa escura da seção
  z-index: -2;
`;
  ...
  return (
    <Section>
      <Container>
        ...
        {/* Card 1 */}
        <Card>
          <img src="/path-to-your-image-1.svg" alt="Lógica de Programação" />
        ...
        {/* Card 2 */}
        <Card>
          <img src="/path-to-your-image-2.svg" alt="Frontend" />
          <h3>Frontend</h3>
